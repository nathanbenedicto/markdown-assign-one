...
Statistical method that can be used in this study includes Predictive analysis, wherein a wide range of probabilistic techniques such as data mining, big data, predictive modeling, artificial intelligence and simulations [26] can be used to predict the time perfect for booking. Specifically statistical hypothesis tests and Linear Regression targeting the different factors or variables affect the flight fare.
Overall, the population benefiting from this are customers/passengers looking for a cheap price to pay for their flight. 
